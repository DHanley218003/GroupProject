	...
	{		
		...
		// Car
		{
			...
			for(int i=0; i<7; i++)
			{
				...
				{
					bd.position.Set(-0.7f+i*0.2f, 0.83f);
			...
			a.x = -1.0f; // position at base of rear wheel
			a.y = 0.03f;
			p.x = -1.0;	// position of the rear wheel hub.
			p.y = 0.4f;
