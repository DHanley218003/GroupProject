...
public:
	...
	{		
		...
		// JadgTiger
		{
			...
			vertices[0].Set(6.0f, 2.58f);
			vertices[1].Set(6.27f, 2.5f);
			vertices[2].Set(6.3f, 2.57f);
			vertices[3].Set(6.03f, 2.65f);
			miscGun.Set(vertices, 4);
			...
			m_gun->CreateFixture(&miscGun, 1.0f);
